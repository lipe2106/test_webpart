...
export default class ImprovementForm extends React.Component<IImprovementFormProps, {}> {
  public render(): React.ReactElement<IImprovementFormProps> {
    ...
    return (
      <section className={`${styles.improvementForm} ${hasTeamsContext ? styles.teams : ''}`}>
